...
/// Aba Topos/Vales do drawer principal (só intraday).
///
/// A análise diária (Range 1D, perfil agregado, topos/vales 1D) vive no
/// widget próprio (issue #12): `daily/daily_panel.dart`.
