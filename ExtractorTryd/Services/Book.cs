...
namespace ExtractorTryd.Services
{
    public class Book
    {
        ...
        public static readonly int BookRows = 25;
                ...
                using (Socket socket = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp))
                {
                    ...
                    while (!stoppingToken.IsCancellationRequested)
                    {
                        ...
                        while ((indexSharp = Array.IndexOf(data, (byte)35)) >= 0)
                        {
                            ...
                            // decode message asynchronously (fire-and-forget)
                            _ = Decode(messageBytes, worker);
                        }
        ...
        public static async Task Decode(byte[] data, BackgroundWorker worker)
        {
            ...
            await hubConnection.SendAsync("SendDataBook", data);
